...
xETitleElement.prototype = {
	initialize: function(title){
		...
		tAnc.setAttribute("href", "javascript:gsInit(\'" + Edit_PointUseAtHref(eStr) + "\');");
						...
						with (El) {
							switch (ni) {
								case 0: case 1: case 2: case 3:
									...
									switch (ni) {
										case 0: case 1:
											if(cnd[ni].firstChild.nodeValue == "Various Artists"){
			...
			$('.titleToggle').click(function(){
				...
				$(this).parent().next().slideToggle("normal",function(){
					if($(this).css("display") == "none"){
						$_tgl.attr({title: "Open"});
						$_tgl.text("▶");
					}else{
						$_tgl.attr({title: "Close"});
						$_tgl.text("▼");
					}
				});
			});
